...
public class MenuHandler {
                    ...
                    case 1:
                        ...
                        if (serviceAluno.existe(matricula)) {
                            ...
                            if (!serviceTurma.existe(idTurma)) {
                                ...
                                System.out.println("ERRO: A turma precisa ter Curso, Disciplina e Professor vinculados!");
                            } else {
    ...
    private static void carregarDadosIniciais() {
        ...
        try {
            ...
            serviceProfessor.inserir(new Professor("João Silva", "111.111.111-11", "(84) 99999-0001", "joao.silva@email.com", "Estrutura de Dados", 8500.00, 1));
            serviceProfessor.inserir(new Professor("Maria Santos", "222.222.222-22", "(84) 99999-0002", "maria.santos@email.com", "POO", 9000.00, 2));
            serviceProfessor.inserir(new Professor("Pedro Costa", "333.333.333-33", "(84) 99999-0003", "pedro.costa@email.com", "Banco de Dados", 8800.00, 3));
            ...
            Aluno a1 = new Aluno("Ana Paula", "444.444.444-44", "(84) 98888-0001", "ana.paula@email.com", "Ciência da Computação", 20231001);
            serviceTurma.buscar(1).adicionarAluno(a1);
            serviceAluno.inserir(a1);

            Aluno a2 = new Aluno("Carlos Eduardo", "555.555.555-55", "(84) 98888-0002", "carlos.eduardo@email.com", "Ciência da Computação", 20231002);
            serviceTurma.buscar(1).adicionarAluno(a2);
            serviceAluno.inserir(a2);

            Aluno a3 = new Aluno("Beatriz Lima", "666.666.666-66", "(84) 98888-0003", "beatriz.lima@email.com", "Engenharia de Software", 20231003);
            serviceTurma.buscar(2).adicionarAluno(a3);
            serviceAluno.inserir(a3);

            Aluno a4 = new Aluno("Daniel Souza", "777.777.777-77", "(84) 98888-0004", "daniel.souza@email.com", "Sistemas de Informação", 20231004);
            serviceTurma.buscar(3).adicionarAluno(a4);
            serviceAluno.inserir(a4);

            Aluno a5 = new Aluno("Fernanda Oliveira", "888.888.888-88", "(84) 98888-0005", "fernanda.oliveira@email.com", "Ciência da Computação", 20231005);
